...
var HelpDialog_HelpDialog = /*#__PURE__*/function () {
  ...
  HelpDialog_createClass(HelpDialog, [{
    ...
    value: function initialize() {
      var $container = this.options.dialogsInBody ? this.$body : this.options.container;
      var body = ['<p class="text-center">', '<a href="http://summernote.org/"  >Summernote 0.8.18</a> · ', '<a href="https://github.com/summernote/summernote"  >Project</a> · ', '<a href="https://github.com/summernote/summernote/issues"  >Issues</a>', '</p>'].join('');
      this.$dialog = this.ui.dialog({
