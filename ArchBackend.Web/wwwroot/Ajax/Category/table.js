        ...
        "columns": [
            ...
            },
            {
                ...
                "data": null, "render": function (row) {
                    ...
                    var buttons = `
                    <a class='btn btn-warning me-1' href="/CategoryUpdate/${id}" data-bs-toggle="tooltip" title="Update Category"><i class="fa-solid fa-pen"></i></a>
                    <button type="button" class="btn btn-danger deleteButton" data-id="${id}" data-bs-toggle="tooltip" title="Delete Category"><i class="fa-solid fa-trash"></i></button>`;
