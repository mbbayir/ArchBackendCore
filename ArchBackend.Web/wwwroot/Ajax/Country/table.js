        ...
        "columns": [
            ...
            },
            {
                "data": null, "render": function (data, type, row) {
                    if (row.user) {
                        ...
                        return `<span class="badge bg-danger fa-beat-fade">No User</span>`;
                    }
                }
            },
            {
            ...
            },
            {
                ...
                "data": null, "render": function (row) {
                    ...
                    var id = row.id,
                        buttons = `
                        <a class='btn btn-warning me-1' href="/CountryUpdate/${id}" data-bs-toggle="tooltip" title="Update Country"><i class="fa-solid fa-pen"></i></a>
                    `;
                    //<button type="button" class="btn btn-danger deleteButton" data-id="${id}" data-bs-toggle="tooltip" title="Delete Country">
